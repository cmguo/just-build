...
publish-public : $(TARGET_FILE_FULL)
	...
	@$(ECHO) "$(LN) $(TARGET_FILE_FULL) $(ROOT_PUBLISH_DIRECTORY)/$(PLATFORM_STRATEGY_NAME)/$(TARGET_FILE_VERSION)"
	@$(LN) $(TARGET_FILE_FULL) $(ROOT_PUBLISH_DIRECTORY)/$(PLATFORM_STRATEGY_NAME)/$(TARGET_FILE_VERSION)

.PHONY: publish-test
publish-test : $(TARGET_FILE_FULL)
	@$(ECHO) "$(MKDIR) $(ROOT_TEST_DIRECTORY)/$(PLATFORM_STRATEGY_NAME)"
	@$(MKDIR) $(ROOT_TEST_DIRECTORY)/$(PLATFORM_STRATEGY_NAME) 
	@$(ECHO) "$(LN) -s $(REVERT_TEST_DIRECTORY)/$(TARGET_FILE_FULL) $(ROOT_TEST_DIRECTORY)/$(PLATFORM_STRATEGY_NAME)/$(TARGET_FILE_VERSION)"
	@$(LN) -s $(REVERT_TEST_DIRECTORY)/$(TARGET_FILE_FULL) $(ROOT_TEST_DIRECTORY)/$(PLATFORM_STRATEGY_NAME)/$(TARGET_FILE_VERSION)
