...
## @version     1.0
###############################################################################
include $(ROOT_MAKE_DIRECTORY_PACK)/depends.mk
...
$(DEPEND_FILES): mkdirs
	@$(ECHO) $@
	@$(STRIP) $@ -o $(TARGET_DIRECTORY)/$(PLATFORM_NAME)/$(notdir $@)

$(TARGET_FILE_FULL): $(DEPEND_FILES) $(PACKET_DEPEND_FILES) $(MAKEFILE_LIST) 
	@$(CD) $(TARGET_DIRECTORY) ; tar -czv -f $(TARGET_FILE) $(addprefix $(PLATFORM_NAME)/,$(notdir $(DEPEND_FILES))) $(notdir $(PACKET_DEPEND_FILES)) 2>&0 > /dev/null
