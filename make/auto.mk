...
$(FILE_CONIFG_H): $(FILE_CONFIGURE)
	@echo $@
	$(CD) $(SOURCE_DIRECTORY) && ./configure $(CONFIGURE)
endif

ifeq ($(wildcard $(FILE_MAKEFILE)),)
$(FILE_MAKEFILE): $(FILE_MAKEFILE_IN) $(FILE_CONFIGURE)
	@echo $@
	$(CD) $(SOURCE_DIRECTORY) && CC=$(CC) CFLAGS="$(COMPILE_FLAGS) LDFLAGS="$(LINK_FLAGS)" ./configure $(CONFIGURE)
endif

$(LOCAL_TARGET): $(FILE_MAKEFILE) $(FILE_CONIFG_H)
	@echo $@
